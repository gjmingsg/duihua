...
<style type="text/css">
   .SubmitButton
	...
	font-size:14px;
        ...
        #teamDWAD_core_hh_xx li{ padding:5px; width:110px}
        #teamDWAD_teachers_hh_xx li{ padding:5px 0px; width:110px;}
</style>
</asp:Content>
...
<nav class="nav">
	<div class="nav_m m">
        ...
        <div class="sNav">
        	<div class="sNav_ico"></div>
            <div class="sNav_list">
            	<a href="####" data-fixed=".section1">关于对画</a>
            	<a href="####" data-fixed=".section2">对画资讯</a>
            	<a href="####" data-fixed=".section3" >对画成绩</a>
            	<a href="####" data-fixed=".section4" >对画团队</a>
            	<a href="####" data-fixed=".section5">对画作品</a>
            	<a href="####" data-fixed=".section6">对画观点</a>
            	<a href="####" data-fixed=".section7">对画出版</a>
            	<a href="####" data-fixed=".section8">联系对画</a>
            </div>
        </div>
    </div>
</nav>
                   ...
                   <a href='Detail.aspx?ID=<%=(Information["item0"] as List<Dictionary<String,Object>>)[0]["ID"] %>'>
                        ...
                        <div class="module_relative">
                            ...
                            <%
                                ...
                                foreach(var ti in t){ %>
                                 <li style="text-overflow: ellipsis;padding:5px"> <%=ti["Title"]%></li>
                                <% } %>  
                                </ul>
                            </div>
                        </div>
        ...
        <div class="teamDWAD_m clearfix">
            ...
            <div class="teamDWAD_core fade-left animate4">
            	<a href='Detail.aspx?ID=<%=(Team["item1"] as Dictionary<String,object>)["ID"] %>'>
                    <h2 id="teamDWAD_core_hh"><%=(Team["item1"] as Dictionary<String,object>)["TypeName"] %></h2>
            ...
            <div class="teamDWAD_teachers fade-left animate4">
                 <a href='Detail.aspx?ID=<%=(Team["item2"] as Dictionary<String,object>)["ID"] %>'>
                    <h2 id="teamDWAD_teachers_hh"><%=(Team["item2"] as Dictionary<String,object>)["TypeName"] %></h2>
        ...
        <div class="worksDWAD_m clearfix">
        	<div class="worksDWAD_pt module_pt lfloat">
                ...
                <div class="worksDWAD_txt module_txt">
                		<h2>教师作品<sub>TEACHERS' WORK</sub></h2>
                    <p><a href="ImageList.aspx?ID=AA661634-B375-45B5-9EC3-3922979DF5B7">素描（静物、人像）</a></p>
                    <p><a href="ImageList.aspx?ID=AA661634-B375-45B5-9EC3-3922979DF501">色彩（静物、人像）</a></p>
                    <p><a href="ImageList.aspx?ID=2A25436B-B23B-4C53-A489-30F2EABEE501">速写（人物、场景）</a></p>
                    <p><a href="ImageList.aspx?ID=2A25436B-B23B-4C53-A489-30F2EABEE502">设计（创意、装饰画）</a></p>
                </div>
            </div>
            <div class="worksDWAD_pt module_pt rfloat">
                ...
                <div class="worksDWAD_txt module_txt">
                	<h2>学生作品<sub>STUDENTS' WORK</sub></h2>
                    <p><a href="ImageList.aspx?ID=2E3920DD-3FD1-4947-866D-6AC79317529E">素描（静物、人像）</a></p>
                    <p><a href="ImageList.aspx?ID=2A25436B-B23B-4C53-A489-30F2EABEE503">色彩（静物、人像）</a></p>
                    <p><a href="ImageList.aspx?ID=2A25436B-B23B-4C53-A489-30F2EABEE504">速写（人物、场景）</a></p>
                    <p><a href="ImageList.aspx?ID=2A25436B-B23B-4C53-A489-30F2EABEE505">设计（创意、装饰画）</a></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="publishedDWAD_m clearfix">
        	<div class="publishedDWAD_pt module_pt lfloat">
                ...
                <div class="publishedDWAD_txt module_txt">
                   ...
                   <%=(Publish["item1"] as Dictionary<String,Object>)["Content"].ToString().Substring(0,150) + "..." %>
                </div>
            </div>
            <div class="publishedDWAD_pt module_pt rfloat">
                ...
                <div class="publishedDWAD_txt module_txt">
                 ...
                 <%=(Publish["item2"] as Dictionary<String, Object>)["Content"].ToString().Substring(0, 150) + "..."%>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="leave_msg">
            	<form  method="post" runat="server">
                    <div class="leaveMsg_contact clearfix">
                        <input class="leave_name lfloat" type="u" name="UserName" id="UserName" placeholder="姓名"/>
...
<script type="text/javascript" >
    $(document).ready(function () {
        ...
        $('#teamDWAD_core_hh').mouseover(function (e) {
            if (document.getElementById('teamDWAD_core_hh_xx')) return;
            var lefter = e.offsetX;
            var topper = e.offsetY - 140;
            var showStr = '<div id="teamDWAD_core_hh_xx" style="position: absolute; top:' + topper + 'px; left:' + lefter + '; width:150px; height:130px; border:2px solid black;font:normal 10pt tahoma; " >' +
            '<ul style="margin-left:20px"><li>校长/教学总监</li><li>素描教研主任</li><li>色彩教研主任</li><li>速写教研主任</li><li>设计教研主任</li></ul></div>';
            $(this).prepend(showStr);
        });
        $('#teamDWAD_teachers_hh').mouseover(function (e) {
            if (document.getElementById('teamDWAD_teachers_hh_xx')) return;
            var lefter = e.offsetX;
            var topper = e.offsetY + 50;
            var showStr = '<div id="teamDWAD_teachers_hh_xx" style="position: absolute; top:' + topper + 'px; left:' + lefter + '; width:150px; height:80px; border:2px solid black;font:normal 10pt tahoma; " >' +
            '<ul style="margin-left:10px"><li>素描组团队成员</li><li>色彩组团队成员</li><li>速写组团队成员</li></ul></div>';
            $(this).append(showStr);
        });
