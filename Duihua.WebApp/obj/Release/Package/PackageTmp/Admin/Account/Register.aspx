<%@ Page Title="注册" Language="C#" MasterPageFile="~/Admin/AdminDefault.master" AutoEventWireup="true"
    CodeBehind="Register.aspx.cs" Inherits="Duihua.WebApp.Admin.Account.Register" %>

<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="head">
</asp:Content>
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolderContainer">
    <asp:CreateUserWizard ID="RegisterUser" runat="server" EnableViewState="false" OnCreatedUser="RegisterUser_CreatedUser" FinishCompleteButtonImageUrl="~/Admin/Account/UserList.aspx">
        <LayoutTemplate>
