<%@ Page Title="更改密码" Language="C#"  MasterPageFile="~/Admin/AdminDefault.Master" AutoEventWireup="true"
    CodeBehind="ChangePassword.aspx.cs" Inherits="Duihua.WebApp.Admin.Account.ChangePassword" %>

<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="head">
</asp:Content>
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolderContainer">
    <h2>
        更改密码
    </h2>
    <p>
    ...
    <asp:ChangePassword ID="ChangeUserPassword" runat="server" CancelDestinationPageUrl="~/Admin/Account/ChangePassword.aspx" EnableViewState="false" RenderOuterTable="false" 
