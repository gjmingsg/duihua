<%@ Page Title="更改密码" Language="C#" MasterPageFile="~/Layout/Personal.master" AutoEventWireup="true"
            ...
            <div class="accountInfo">
                <fieldset class="changePassword">
                    ...
                    <p>
                        ...
                        <asp:TextBox ID="CurrentPassword" runat="server"  TextMode="Password" CssClass="form-control passwordEntry "></asp:TextBox>
                ...
                <p class="submitButton">
                 <asp:Button ID="ChangePasswordPushButton" runat="server" CommandName="ChangePassword" Text="更改密码" 
                         ValidationGroup="ChangeUserPasswordValidationGroup" CssClass="btn btn-primary"/>
                    <asp:Button ID="CancelPushButton" runat="server" CausesValidation="False" CommandName="Cancel" 
                    Text="取消"  CssClass="btn btn-default"/>
