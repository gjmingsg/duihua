<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/AdminDefault.Master" AutoEventWireup="true" CodeBehind="HomeworkResult.aspx.cs" Inherits="Duihua.EducationWeb.Modules.Homework.HomeworkResult" %>
...
<div class="row">
        ...
        <%foreach (var item in MyCourse)
          ...
          <ul class="nav nav-sidebar">
            <li class="active"><a href="#"><%=item["CourseName"].ToString()%></a></li>
            <%
                var temp = GetHomeWorkByCourseID(item["CourseID"].ToString());
                foreach (var initem in temp)
              { %>
                <li><a href='<%=initem["WorkID"] %>'><%=initem[Title]%></a></li>
              <%} %>
          </ul>
         <%} %>
        </div>
